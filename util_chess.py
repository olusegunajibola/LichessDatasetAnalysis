...
class Description:
    def __init__(self, chess):
        self.desc_data = chess.describe()
        
    def frame(self):
        desc = round(self.desc_data,2)
    ...
    def to_csv(self, filename):
        desc = self.frame()
        desc.to_csv(filename, index=True)
...
class OutcomeStats:
    ...
    def piechart(self, filename):
        ...
        outcome_chart.plot(kind='pie', y = 'Total', autopct='%1.2f%%',
                           ...
                           labels=outcome_chart['victory_status'], explode= [.1 , .01, .01 , 0],
...
class WinnerColour:
    ...
    def barchart(self, filename):
        ...
        ax = sns.barplot(y = 'Number of Victories', x = 'winner',  data = winner, palette=[ "#FFD700" , "#000000",'#F5F5F5'], edgecolor='black')
...
class PlayersRating:
    ...
    def figure(self, filename):
        ...
        sns.histplot(self.white_rating, bins = 20, ax = ax[0], kde=True, color = 'blue',edgecolor='white')
        #Distribution of black's rating
        sns.histplot(self.black_rating, bins = 20, ax = ax[1], kde=True, color = 'black', edgecolor='white')
